    ...
    <div className="relative min-h-screen bg-white dark:bg-black overflow-x-hidden">
        ...
        <div className="mx-auto max-w-4xl glass p-10 sm:p-16 rounded-[3rem] border border-zinc-200 dark:border-zinc-800 shadow-2xl relative overflow-hidden group">
          ...
          <div className="space-y-8 relative z-10">
            ...
            <h2 className="text-3xl sm:text-5xl font-black tracking-tight leading-tight">
              Bridging the gap between <span className="text-purple-600">Streamers</span> and <span className="text-blue-600">Viewers</span>.
            </h2>
            <p className="text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium">
              DropQueue is not just a music bot; it&apos;s a collaborative stage. We believe music is most powerful when shared. 
              Our goal is to provide the ultimate toolkit for streamers to curate their broadcast&apos;s vibe while giving viewers 
              a voice in the soundtrack of their favorite communities.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-8">
              {[
                { icon: Globe, title: "Global Reach", desc: "Connect anyone, anywhere." },
                { icon: Music, title: "Pure Audio", desc: "Lossless quality focus." },
                { icon: Sparkles, title: "Vibe Control", desc: "Intelligent queueing." }
              ].map((item, i) => (
      ...
      <section id="discover" className="relative z-10 mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8 space-y-16">
        <div className="flex flex-col items-center text-center space-y-4">
          <span className="text-[10px] font-black uppercase tracking-[0.4em] text-zinc-400">Live Explorer</span>
          <h3 className="text-4xl font-black tracking-tighter sm:text-5xl">
            Active <span className="bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">Broadcasts</span>
          </h3>
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-black uppercase text-zinc-400 tracking-widest">
                        {session.status === "ACTIVE" ? "On Air" : "Paused"}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-3">
                  <div className="px-4 py-1.5 rounded-full bg-zinc-100 dark:bg-zinc-900 text-[10px] font-black uppercase tracking-widest text-zinc-500 border border-zinc-200 dark:border-zinc-800">
                    {session._count.tracks} Tracks in queue
                  </div>
          ...
          <div className="glass p-2 rounded-[3.5rem] border border-dashed border-zinc-300 dark:border-zinc-700 flex flex-col items-center justify-center min-h-[350px] text-center space-y-8 group hover:border-purple-500/50 transition-all">
             ...
             <div className="space-y-3 px-8">
               <h3 className="text-xl font-black tracking-tight">Ready to lead?</h3>
               <p className="text-xs text-zinc-500">Start your own session and redefine how your audience hears you.</p>
             </div>
              {session ? (
                <Link 
                  href="/dashboard"
      ...
      <footer className="relative z-10 border-t border-zinc-100 dark:border-zinc-900 py-16">
        <div className="mx-auto max-w-7xl px-4 flex flex-col items-center space-y-6">
          ...
          <p className="text-zinc-500 text-[10px] font-black uppercase tracking-[0.2em] flex items-center gap-2">
            Handcrafted with <Heart size={10} className="text-red-500 animate-bounce" /> by <span className="text-zinc-900 dark:text-zinc-100">laran-devs</span>
          </p>
          <div className="text-[8px] text-zinc-400 font-mono">
            &copy; {new Date().getFullYear()} DropQueue. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
